...
echo -e "${CYAN}"
echo "################################################################"
echo "#         Start downloading and installing  cutsclear_1.2      #"
echo "################################################################"
echo -e "${NC}"

IPK_URL="https://raw.githubusercontent.com/Ham-ahmed/2802/refs/heads/main/enigma2-plugin-extensions-cutsclear_1.2_all.ipk"
IPK_NAME="enigma2-plugin-extensions-cutsclear_1.2_all.ipk"
