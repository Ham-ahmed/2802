...
echo -e "${CYAN}"
echo "################################################################"
echo "#   Start downloading and installing  epgimport_2.9.3_iet5     #"
echo "################################################################"
echo -e "${NC}"

IPK_URL="https://raw.githubusercontent.com/Ham-ahmed/2802/refs/heads/main/enigma2-plugin-extensions-epgimport_2.9.3_iet5_all.ipk"
IPK_NAME="enigma2-plugin-extensions-epgimport_2.9.3_iet5_all.ipk"
