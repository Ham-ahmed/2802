...
echo -e "${CYAN}"
echo "################################################################"
echo "#         Start downloading and installing  xklass_1.77        #"
echo "################################################################"
echo -e "${NC}"

IPK_URL="https://raw.githubusercontent.com/Ham-ahmed/2802/refs/heads/main/enigma2-plugin-extensions-xklass_1.77.20260224_all.ipk"
IPK_NAME="enigma2-plugin-extensions-xklass_1.77.20260224_all.ipk"
